...
#BOARD_TEMPLATE = '"""'
WHITE_SQUARE = '||'
BLACK_SQUARE = '  '# Write your code here :-)
    ...
    for y in '87654321':
        ...
        for x in 'abcdefgh':
            ...
            if square in board:
                ...
                piece = WHITE_SQUARE if is_white_square else BLACK_SQUARE
                #if is_white_square:
...
print('by Al Sweigard al@inventwithpython.com')
print()
print('Pieces:')
print(' w - White, b - Black')
print(' P - Pawn, N - Knight, B - Bishop, R - Rook, Q - Queen, K - King')
print('Commands:')
print(' move e2 e4 - Moves the pieces at e2 to e4')
